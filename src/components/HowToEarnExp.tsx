    ...
    return (
        <div className="w-fit text-white">
            <Image
                removeWrapper
                width={423}
                src={"/images/howtoearn.png"}
                className="static"
            />
            <div className="absolute top-16 pl-7 xl:top-12 xl:pl-5">
                <div className="mb-3.5 font-clashDisplayBold text-4xl xl:mb-2 xl:text-2xl">
                    How to earn EXP?
                </div>
                ...
                >
                    <div className="font-clashDisplayMedium text-base text-buttonSecondary underline">
                        Details
                    </div>
                </Link>
            </div>
