    ...
    return (
        <AppLayout>
            <div className="flex h-fit w-full items-center justify-center gap-4 bg-[#004DFF1A] md:gap-2">
                <Button
                    variant="light"
                    className="border-b-1 border-b-primaryHover sm:h-fit sm:px-2 sm:py-2"
                    radius="none"
                >
                    <TitleT2 className="text-primaryHover sm:h-fit sm:text-[10px] sm:leading-3">
                        My Nest
                    </TitleT2>
                ...
                >
                    <TitleT2 className="leading-3 text-disable sm:h-fit sm:text-[10px]">
                        Leaderboard
                    </TitleT2>
                        ...
                        <div className="relative flex items-end justify-between">
                            <div className="relative text-white">
                                ...
                                <div className="absolute left-8 top-16 xl:left-4 xl:top-10">
                                    <div className="mb-1.5 font-clashDisplayBold text-5xl xl:text-3xl">
                                        Season I
                                    </div>
                                    <div className="rounded-md bg-[#2667FE] px-2 py-1 font-clashDisplay text-xs font-medium">
                                        00:00 UTC July 15 - 2024 - 00:00 UTC
                                        October 1 - 2024
                                    </div>
                                </div>
                            </div>
