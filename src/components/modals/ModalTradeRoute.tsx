...
export default function ModalTradeRoute({
    ...
    const gap = useMemo(
        () =>
            isLg
                ? { gap2: "gap-[0px]", gap3: "gap-[0px]" }
                : { gap2: "gap-[98px]", gap3: "gap-[32px]" },
        [isLg],
    );
    const longestPathLength = useMemo(
        () =>
            paths.reduce<number>((max, path) => Math.max(max, path.length), 1),
        [paths],
    );
            ...
            >
                <ModalContent
                    className={
                        ...
                        " " +
                        (isLg
                            ? "h-fit max-h-[70vh] min-h-[200px] self-end"
                            : "")
                    }
                >
                    <>
                        <div className="flex items-center justify-between">
                            <TitleT1 className="w-[120px] text-buttonSecondary">
                                Swap route
                            </TitleT1>
                            ...
                            <div className="max-h-[70vh] w-full">
                                {displayTokenSymbolInSeparateRow && (
                                    <div className="flex items-center justify-between">
                                        <Image
                                            src={
                                                followingTokenData[srcCoinType]
                                                    ?.logoUrl ||
                                        ...
                                        <Image
                                            src={
                                                followingTokenData[dstCoinType]
                                                    ?.logoUrl ||
                                                NOT_FOUND_TOKEN_LOGO_URL
                                            }
                                            width="44px"
                                ...
                                {paths.map((path, pathIndex) => (
                                    <div
                                        key={pathIndex}
                                        className="relative flex h-[44px] items-center"
                                    >
                                        {!displayTokenSymbolInSeparateRow ? (
                                            pathIndex === 0 ? (
                                                <Image
                                                ...
                                                <Fragment key={hopIndex}>
                                                    <div className="flex w-[120px] items-center justify-center md:w-[80px]">
                                                        <Button
                                                            ...
                                                            onPress={() =>
                                                                window.open(
                                                                    `https://aptoscan.com/account/${hop.poolId.split("::")[0]}`,
                                                                    "_blank",
                                                                )
                                                            }
                                                            disableAnimation
                                                    ...
                                                    {hopIndex !==
                                                        ...
                                                        <Button
                                                            ...
                                                            onPress={() =>
                                                                window.open(
                                                                    `https://aptoscan.com/coin/${hop.dstCoinType}`,
                                                                    "_blank",
                                                                )
                                                            }
                                                        >
