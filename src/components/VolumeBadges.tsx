...
export default function VolumeBadges() {
  return (
    <div
      className="relative grid w-full items-center justify-center rounded-xl border-1 border-[#0165A3] bg-[radial-gradient(132.5%_219.17%_at_80.49%_128.61%,#2667FE_0%,#0041DA_9.72%,#030181_21.71%,#001343_36.96%,#000000_69.59%)] px-10 py-8 text-white xl:px-8 xl:py-6 sm:py-2.5 sm:px-3">
      <div className="mb-7 sm:mb-2 flex gap-5 xl:gap-3">
