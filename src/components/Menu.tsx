...
export default function Menu() {
  ...
  return (
    <div className="flex items-center gap-4 sm:gap-0 md:justify-center md:gap-2">
      <Button
        variant="light"
        className={"min-w-0 rounded px-4 s sm:px-2 sm:py-2 sm:h-fit" + (isActiveSwap ? " border-1 border-primaryHover" : "")}
        onPress={() => {
      ...
      <Button
        variant="light"
        className={"gap-1 sm:gap-0.5 rounded px-4  sm:px-1 sm:py-2 sm:h-fit" + (isActiveTheNest ? " border-1 border-primaryHover" : "")}
      ...
      <Button variant="light" className="gap-1 sm:gap-0.5 rounded px-4 sm:px-1 sm:py-2 sm:h-fit" isDisabled>
