            ...
            <div className="mb-0.5 flex gap-2.5 sm:gap-1">
                {expLevels.map((value, index) => (
                    <Image
                        ...
                        width={isSm ? 10 : 21}
                        src={
                            !totalPoint.lessThan(value)
                                ? "/images/starenable.png"
                                : "/images/stardisable.png"
                        }
                    />
                ))}
            </div>
            <div className="flex flex-row flex-wrap items-center justify-center">
                <div className="mr-1.5 font-clashDisplay text-base font-bold text-white sm:mr-0.5 sm:text-[7px]">
                    {name}
                </div>
                <Icon
                    width={isSm ? 8 : 18}
