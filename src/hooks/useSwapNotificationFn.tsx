        ...
        (
            ...
            if (tokenInData && tokenOutData) {
                const payload: ITransactionHistory = {
                    ...
                    readableAmountIn: divpowToFraction(
                        amountIn,
                        tokenInData.decimals,
                    ).toSignificant(6),
                    readableAmountOut: divpowToFraction(
                        amountOut,
                ...
                toast(
                    payload.isSuccess ? (
                        <div className="rounded bg-[rgba(24,207,106,0.2)] p-4">
                            <TitleT2>
                                Swap {payload.readableAmountIn}{" "}
                                {payload.tokenInSymbol} to{" "}
                                {payload.readableAmountOut}{" "}
                        ...
                        <div className="rounded bg-[rgba(244,70,70,0.2)] p-4">
                            <TitleT2>
                                Error swapping {payload.readableAmountIn}{" "}
                                {payload.tokenInSymbol} to{" "}
                                {payload.readableAmountOut}{" "}
                                {payload.tokenOutSymbol}
                            </TitleT2>
                    ...
                    ),
                    {
                        ...
                        progressClassName: payload.isSuccess
                            ? "z-toast-progress-success"
                            : "z-toast-progress-failed",
                        autoClose:
                            payload.isSuccess || isDesktop ? 4000 : false,
