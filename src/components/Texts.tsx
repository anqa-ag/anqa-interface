...
export const TitleT1 = forwardRef<HTMLDivElement, TextProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
...
export const TitleT2 = forwardRef<HTMLDivElement, TextProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
...
export const TitleT4 = forwardRef<HTMLDivElement, TextProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
...
export const TitleT5 = forwardRef<HTMLDivElement, TextProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
...
export const BodyB1 = forwardRef<HTMLDivElement, TextProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
...
export const BodyB2 = forwardRef<HTMLDivElement, TextProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
...
export const BodyB3 = forwardRef<HTMLDivElement, TextProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
