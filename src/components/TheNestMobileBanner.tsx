...
function HowToEarnExpBanner() {
  return (
    <div className="relative text-white" key="banner-2">
      <Image width="100%" src={'/images/the_nest_mobile_banner_2.png'} className="static" radius="none" />
      <div className="absolute left-6 top-3 flex flex-col items-start">
        ...
        >
          <div className="font-clashDisplayMedium text-sm leading-[14px] text-buttonSecondary">Details</div>
        </Link>
      </div>
    </div>
  )
